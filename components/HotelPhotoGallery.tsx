...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  const remainingPhotosCount = totalPhotos - displayPhotos.length;
  ...
  return (
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        ...
        {showModal && (
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-opacity-90 z-[55]">
            <div className="h-[75vh] w-[320px] md:w-[700] relative">
              <Image
                src={photos[currentPhotoIndex].url}
                alt={`Room Photo ${currentPhotoIndex + 1}`}
                width={150}
              ...
              <div className=" flex justify-between items-center py-3">
                <div className="flex space-x-2 items-center dark:text-white white:text-black ">
                  <FaArrowLeft
                    className="currsor-pointer"
                    onClick={handlePreviouse}
                  />
